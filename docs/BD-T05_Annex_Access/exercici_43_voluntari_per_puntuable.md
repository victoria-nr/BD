...
[« Anterior](422_modificaci_per_a_la_base_de_dades_actual.md) | [Següent »](43_el_panell_de_navegaci.md)
# <a name="main"></a>**Exercici 4.3 (voluntari però puntuable)**
![](exercici_43_voluntari_per_puntuable.002.png)
## **Exercici 4.3 (voluntari però puntuable)**
Construeix la cinta d'opcions per a la Base de Dades de l'apartat 4.2.2.

En aquest cas no cal guardar cap imatge, perquè lliurareu tota la Base de Dades
