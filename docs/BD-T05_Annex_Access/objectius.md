...
![](objectius.002.png)
## **Objectius**
En la primera part d'aquest tema s'ha seguit un tutorial per a conéixer els aspectes més bàsics d'Access. Els objectius d'aquesta segona part són: 

- Assegurar-nos que els conceptes bàsics referents a Taules, Consultes, Formularis i Informes s'han assolit convenientment.

- Desenvolupar Macros, com a eina senzilla d'encadenar accions que responguen a un determinat esdeveniment.

- Desenvolupar procediments i funcions per a fer tractaments potents en resposta a determinats esdeveniments.

- Configurar Access per a que tinga un aspecte intuitiu i atractiu. 

L'objectiu final és aconseguir aplicacions senceres basades en una Base de Dades 
