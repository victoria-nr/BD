...
[« Anterior](42_la_cinta_dopcions.md) | [Següent »](exercici_42.md)
# <a name="main"></a>**4.2.1 Modificació per a tot Access**
En Access 2013 resulta molt còmode, la modificació general de la cinta d'opcions. Amb modificació general ens referim a una modificació que afectarà sempre a Acess, siga quina siga la Base de Dades que obrim.

Senzillament haurem d'anar a **Archivo → Opciones → Personalizar cinta de opciones**

També es pot anar apretant amb el botó de la dreta sobre qualsevol punt de la cinta d'opcions i triant **Personalizar cinta de opciones**.

En el següent vídeo es crea una fitxa nova en la cinta d'opcions, incorporant moltes de les macros ja creades.
