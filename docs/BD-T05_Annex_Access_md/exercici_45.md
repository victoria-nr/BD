...
[« Anterior](45_el_panell_de_control.md)
# <a name="main"></a>**Exercici 4.5**
![](exercici_45.002.png)
## **Exercici 4.5**
Crea un panell de control com el realitzat en el punt 4.5, on es puga accedir als formularis i informes, organitzat en dos panells, el principal i el d'informes.
