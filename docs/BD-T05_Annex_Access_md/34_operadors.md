...
[« Anterior](33_tipus_especials.md) | [Següent »](35_funcions_i_procediments.md)
# <a name="main"></a>**3.4 Operadors**
Anem a fer un breu resum dels operadors que utilitza Access Basic, agrupats per categries. 



- **OPERADORS MATEMÀTICS**

**+         -         \*         /         \** (disvisió entera)        **Mod** (mòdul)         **^** (exponencial) 

- **OPERADORS RELACIONALS**

**=         <>         <         >         <=**        **>=**         **Is** (igualtat d'objectes) 

- **OPERADORS LÒGICS**

**Not         And         Or         Xor         Eqv** (comparació binària)       
