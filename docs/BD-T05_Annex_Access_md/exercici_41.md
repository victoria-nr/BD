...
[« Anterior](41_configurar_la_barra_daccs_rpid.md) | [Següent »](42_la_cinta_dopcions.md)
# <a name="main"></a>**Exercici 4.1**
![](exercici_41.002.png)
## **Exercici 4.1**
Configura la Barra d'accés ràpid tal i com s'ha mostrat en l'apartat 4.1.

Fes una captura de **tota la finestra d'Access** on es veja la barra d'accés ràpid. Anomena-la **Exercici4\_1.png** (o **.jpg**)
