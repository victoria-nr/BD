...
[« Anterior](421_modificaci_per_a_tot_access.md) | [Següent »](422_modificaci_per_a_la_base_de_dades_actual.md)
# <a name="main"></a>**Exercici 4.2**
![](exercici_42.002.png)
## **Exercici 4.2**
Captura una imatge on es veja la pestanya **FITXA EMPRESA** de la cinta d'opcions. . Anomena-la **Exercici4\_2.png** (o **.jpg**)
