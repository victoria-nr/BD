...
Aquesta pràctica té la voluntat de servir de repàs del tutorial d'Access. Seran una sèrie de exercicis sobre una mateixa Base de Dades, la corresponent a l'exemple amb què s'il·lustra el Tema 2: Model Entitat-Relació. Repetim ací la breu anàlisi de requisits de l' **Empresa**: 
